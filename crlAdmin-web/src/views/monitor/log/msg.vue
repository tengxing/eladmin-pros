...
export default {
  ...
  data() {
    return {
      ...
      data: [{ name: 'crlAdmin-', timestamp: new Date(), threadName: 'system-prompt-message', level: 'INFO', className: 'cn.littleterry.AppRun' + ' :', body: 'Welcome, no log output' }],
      // level
